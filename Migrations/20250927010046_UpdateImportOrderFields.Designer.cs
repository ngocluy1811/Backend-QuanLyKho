...
namespace FertilizerWarehouseAPI.Migrations
{
    ...
    [Migration("20250927010046_UpdateImportOrderFields")]
    partial class UpdateImportOrderFields
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FertilizerWarehouseAPI.Models.Entities.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 9, 27, 1, 0, 44, 720, DateTimeKind.Utc).AddTicks(216),
                            Email = "admin@fwc.com",
                            IsActive = true,
                            Phone = "0123456789",
                            Status = "Active",
