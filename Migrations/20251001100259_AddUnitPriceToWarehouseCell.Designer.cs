...
namespace FertilizerWarehouseAPI.Migrations
{
    ...
    [Migration("20251001100259_AddUnitPriceToWarehouseCell")]
    partial class AddUnitPriceToWarehouseCell
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FertilizerWarehouseAPI.Models.Entities.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 10, 1, 10, 2, 58, 467, DateTimeKind.Utc).AddTicks(9425),
                            Email = "admin@fwc.com",
                            IsActive = true,
                            Phone = "0123456789",
                            Status = "Active",
