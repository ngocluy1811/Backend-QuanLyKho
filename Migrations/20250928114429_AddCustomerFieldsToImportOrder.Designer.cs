...
namespace FertilizerWarehouseAPI.Migrations
{
    ...
    [Migration("20250928114429_AddCustomerFieldsToImportOrder")]
    partial class AddCustomerFieldsToImportOrder
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FertilizerWarehouseAPI.Models.Entities.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 9, 28, 11, 44, 26, 379, DateTimeKind.Utc).AddTicks(7429),
                            Email = "admin@fwc.com",
                            IsActive = true,
                            Phone = "0123456789",
                            Status = "Active",
            ...
            modelBuilder.Entity("FertilizerWarehouseAPI.Models.Entities.ImportOrder", b =>
                {
                    ...
                    b.HasOne("FertilizerWarehouseAPI.Models.Entities.Supplier", "Customer")
                        .WithMany()
