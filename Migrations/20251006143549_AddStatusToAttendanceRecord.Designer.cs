...
namespace FertilizerWarehouseAPI.Migrations
{
    ...
    [Migration("20251006143549_AddStatusToAttendanceRecord")]
    partial class AddStatusToAttendanceRecord
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FertilizerWarehouseAPI.Models.Entities.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 10, 6, 14, 35, 47, 355, DateTimeKind.Utc).AddTicks(4985),
                            Email = "admin@fwc.com",
                            IsActive = true,
                            Phone = "0123456789",
                            Status = "Active",
