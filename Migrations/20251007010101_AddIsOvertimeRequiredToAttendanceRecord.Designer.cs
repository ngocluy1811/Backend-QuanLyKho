...
namespace FertilizerWarehouseAPI.Migrations
{
    ...
    [Migration("20251007010101_AddIsOvertimeRequiredToAttendanceRecord")]
    partial class AddIsOvertimeRequiredToAttendanceRecord
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FertilizerWarehouseAPI.Models.Entities.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 10, 7, 1, 1, 0, 175, DateTimeKind.Utc).AddTicks(2684),
                            Email = "admin@fwc.com",
                            IsActive = true,
                            Phone = "0123456789",
                            Status = "Active",
