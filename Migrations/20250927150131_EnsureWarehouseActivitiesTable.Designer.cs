...
namespace FertilizerWarehouseAPI.Migrations
{
    ...
    [Migration("20250927150131_EnsureWarehouseActivitiesTable")]
    partial class EnsureWarehouseActivitiesTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FertilizerWarehouseAPI.Models.Entities.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 9, 27, 15, 1, 30, 447, DateTimeKind.Utc).AddTicks(9641),
                            Email = "admin@fwc.com",
                            IsActive = true,
                            Phone = "0123456789",
                            Status = "Active",
