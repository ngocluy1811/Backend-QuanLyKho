...
namespace FertilizerWarehouseAPI.Migrations
{
    ...
    [Migration("20250926100558_AddImportExportOrders")]
    partial class AddImportExportOrders
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FertilizerWarehouseAPI.Models.Entities.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 9, 26, 10, 5, 56, 797, DateTimeKind.Utc).AddTicks(2772),
                            Email = "admin@fwc.com",
                            IsActive = true,
                            Phone = "0123456789",
                            Status = "Active",
