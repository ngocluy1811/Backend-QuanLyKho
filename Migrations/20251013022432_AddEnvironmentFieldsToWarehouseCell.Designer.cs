...
namespace FertilizerWarehouseAPI.Migrations
{
    ...
    [Migration("20251013022432_AddEnvironmentFieldsToWarehouseCell")]
    partial class AddEnvironmentFieldsToWarehouseCell
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FertilizerWarehouseAPI.Models.Entities.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 10, 13, 2, 24, 28, 877, DateTimeKind.Utc).AddTicks(1117),
                            Email = "admin@fwc.com",
                            IsActive = true,
                            Phone = "0123456789",
                            Status = "Active",
