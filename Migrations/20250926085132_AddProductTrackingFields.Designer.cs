...
namespace FertilizerWarehouseAPI.Migrations
{
    ...
    [Migration("20250926085132_AddProductTrackingFields")]
    partial class AddProductTrackingFields
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FertilizerWarehouseAPI.Models.Entities.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 9, 26, 8, 51, 30, 39, DateTimeKind.Utc).AddTicks(3486),
                            Email = "admin@fwc.com",
                            IsActive = true,
                            Phone = "0123456789",
                            Status = "Active",
