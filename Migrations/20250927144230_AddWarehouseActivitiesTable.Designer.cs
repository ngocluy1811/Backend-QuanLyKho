...
namespace FertilizerWarehouseAPI.Migrations
{
    ...
    [Migration("20250927144230_AddWarehouseActivitiesTable")]
    partial class AddWarehouseActivitiesTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FertilizerWarehouseAPI.Models.Entities.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 9, 27, 14, 42, 29, 485, DateTimeKind.Utc).AddTicks(9148),
                            Email = "admin@fwc.com",
                            IsActive = true,
                            Phone = "0123456789",
                            Status = "Active",
