...
namespace FertilizerWarehouseAPI.Migrations
{
    ...
    [Migration("20250925100034_AddAssignedStaffToWarehouseCell")]
    partial class AddAssignedStaffToWarehouseCell
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FertilizerWarehouseAPI.Models.Entities.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 9, 25, 10, 0, 32, 275, DateTimeKind.Utc).AddTicks(4087),
                            Email = "admin@fwc.com",
                            IsActive = true,
                            Phone = "0123456789",
                            Status = "Active",
