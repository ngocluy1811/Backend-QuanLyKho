...
namespace FertilizerWarehouseAPI.Migrations
{
    ...
    [Migration("20250927014107_AddNewImportOrderFields")]
    partial class AddNewImportOrderFields
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FertilizerWarehouseAPI.Models.Entities.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 9, 27, 1, 41, 6, 720, DateTimeKind.Utc).AddTicks(9059),
                            Email = "admin@fwc.com",
                            IsActive = true,
                            Phone = "0123456789",
                            Status = "Active",
