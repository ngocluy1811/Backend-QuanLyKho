...
namespace FertilizerWarehouseAPI.Migrations
{
    ...
    [Migration("20250926062052_AddProductDetailsToWarehouseCell")]
    partial class AddProductDetailsToWarehouseCell
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FertilizerWarehouseAPI.Models.Entities.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 9, 26, 6, 20, 51, 84, DateTimeKind.Utc).AddTicks(1616),
                            Email = "admin@fwc.com",
                            IsActive = true,
                            Phone = "0123456789",
                            Status = "Active",
