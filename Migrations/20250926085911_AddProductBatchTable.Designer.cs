...
namespace FertilizerWarehouseAPI.Migrations
{
    ...
    [Migration("20250926085911_AddProductBatchTable")]
    partial class AddProductBatchTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FertilizerWarehouseAPI.Models.Entities.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 9, 26, 8, 59, 10, 75, DateTimeKind.Utc).AddTicks(3751),
                            Email = "admin@fwc.com",
                            IsActive = true,
                            Phone = "0123456789",
                            Status = "Active",
