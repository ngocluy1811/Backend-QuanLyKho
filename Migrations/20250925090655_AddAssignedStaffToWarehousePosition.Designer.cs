...
namespace FertilizerWarehouseAPI.Migrations
{
    ...
    [Migration("20250925090655_AddAssignedStaffToWarehousePosition")]
    partial class AddAssignedStaffToWarehousePosition
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FertilizerWarehouseAPI.Models.Entities.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 9, 25, 9, 6, 53, 865, DateTimeKind.Utc).AddTicks(3495),
                            Email = "admin@fwc.com",
                            IsActive = true,
                            Phone = "0123456789",
                            Status = "Active",
