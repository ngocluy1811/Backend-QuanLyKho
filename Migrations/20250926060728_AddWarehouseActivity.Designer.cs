...
namespace FertilizerWarehouseAPI.Migrations
{
    ...
    [Migration("20250926060728_AddWarehouseActivity")]
    partial class AddWarehouseActivity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FertilizerWarehouseAPI.Models.Entities.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 9, 26, 6, 7, 27, 516, DateTimeKind.Utc).AddTicks(1314),
                            Email = "admin@fwc.com",
                            IsActive = true,
                            Phone = "0123456789",
                            Status = "Active",
