...
namespace FertilizerWarehouseAPI.Migrations
{
    ...
    [Migration("20251002065944_AddProductBatchIdToWarehouseCell")]
    partial class AddProductBatchIdToWarehouseCell
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FertilizerWarehouseAPI.Models.Entities.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 10, 2, 6, 59, 42, 766, DateTimeKind.Utc).AddTicks(7324),
                            Email = "admin@fwc.com",
                            IsActive = true,
                            Phone = "0123456789",
                            Status = "Active",
