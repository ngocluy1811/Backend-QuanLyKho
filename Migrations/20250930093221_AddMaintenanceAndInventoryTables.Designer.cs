...
namespace FertilizerWarehouseAPI.Migrations
{
    ...
    [Migration("20250930093221_AddMaintenanceAndInventoryTables")]
    partial class AddMaintenanceAndInventoryTables
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FertilizerWarehouseAPI.Models.Entities.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 9, 30, 9, 32, 19, 992, DateTimeKind.Utc).AddTicks(7425),
                            Email = "admin@fwc.com",
                            IsActive = true,
                            Phone = "0123456789",
                            Status = "Active",
