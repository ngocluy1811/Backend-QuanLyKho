...
namespace FertilizerWarehouseAPI.Migrations
{
    ...
    [Migration("20251006020202_AddPositionAndAddressToUser")]
    partial class AddPositionAndAddressToUser
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FertilizerWarehouseAPI.Models.Entities.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 10, 6, 2, 2, 0, 922, DateTimeKind.Utc).AddTicks(4113),
                            Email = "admin@fwc.com",
                            IsActive = true,
                            Phone = "0123456789",
                            Status = "Active",
