...
namespace FertilizerWarehouseAPI.Migrations
{
    ...
    [Migration("20250927044730_AddBatchFieldsToProductBatch")]
    partial class AddBatchFieldsToProductBatch
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FertilizerWarehouseAPI.Models.Entities.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 9, 27, 4, 47, 29, 101, DateTimeKind.Utc).AddTicks(510),
                            Email = "admin@fwc.com",
                            IsActive = true,
                            Phone = "0123456789",
                            Status = "Active",
